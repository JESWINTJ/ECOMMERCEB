...
function PaymentPage() {
  ...
  // Dummy total amount (reused from checkout page)
  const totalAmount = 1029; // This would typically be passed as a prop or fetched
  ...
  const handlePay = () => {
    ...
    setTimeout(() => navigate('/order-confirmation'), 1500); // Simulate payment processing
  };
